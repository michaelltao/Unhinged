...
const std::string MEMBERS_FILE = "/Users/michaeltao/Downloads/Unhinged/members.txt";
const std::string TRANSLATOR_FILE = "/Users/michaeltao/Downloads/Unhinged/translator.txt";
